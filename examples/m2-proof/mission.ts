/**
 * Plumbing for the M2 proof: the bits that are not themselves the proof.
 *
 * Deliberately standalone — no @missura/* import. Everything here is something
 * a normal SDK user could write, which is the point: the guarantees under test
 * must hold for a client the proxy has never met.
 */
